    ...
    <div className="min-h-screen bg-gradient-vault flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Welcome to AskVault</h1>
          <p className="text-sm text-white/40 mt-1">Admin Console · Secure Access</p>
        </div>
          ...
          <SignIn
            appearance={{
              elements: {
                ...
                identityPreviewEditButton: "text-vault-400",
              },
            }}
          />
        </div>
